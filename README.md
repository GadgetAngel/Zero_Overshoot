...
2. Download `zero_overshoots.py` file and `zero_overshoot.py` file.
3. Download the `ZERO_OVERSHOOT.cfg` and include it into your printer.cfg file.
3. Move `zero_overshoots.py` and `zero_overshoot.py` to your Klipper Extras folder (home/pi/klipper/klippy/extras).
